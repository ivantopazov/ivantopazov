...
(function ($) {
    if($.fn.ajaxForm == undefined) {
        ...
        $.getScript("/addons/scripts/plugins/loadfiles/js/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Перетащите сюда нужный файл</b></span>",
            abortStr: "Отменить",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Готово",
            multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.",
            extErrorStr: "ошибка загрузки. Ожидаемый тип файла: ",
            sizeErrorStr: "ошибка загрузки. Максимальный размер: ",
            uploadErrorStr: "Загружаете не правильный тип файла",
            maxFileCountErrorStr: " ошибка загрузки. Maximum allowed files are:",
            showQueueDiv:false //показывать ли итоговый финиш загрузки?
        ...
        this.hide();
        this.errorLog = $("<div class='upload_text_errror'></div>"); //Writing errors
        ...
        function setDragDropHandlers(obj, s, ddObj) {
            ddObj.on('dragenter', function (e) {
                e.stopPropagation();
                e.preventDefault();
                $(this).css('border', '2px solid #2F8AB9');
            });
            ...
            ddObj.on('drop', function (e) {
                $(this).css('border', '2px dashed  #2F8AB9');
                e.preventDefault();
                obj.errorLog.html("");
            ...
            $(document).on('dragover', function (e) {
                e.stopPropagation();
                e.preventDefault();
                ddObj.css('border', '2px dashed #2F8AB9');
            });
