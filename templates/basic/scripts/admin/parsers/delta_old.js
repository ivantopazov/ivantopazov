	...
	var init = function () {
		...
		MEM.CSV = {
			...
			labels: [
				...
				{name: 'Вид изделия', key: 'vid_izdelia', orig: '2'},
				{name: 'Размер', key: 'size', orig: '3'},
				{name: 'Количество', key: 'qty', orig: '4'},
				{name: 'Вес', key: 'weight', orig: '5'},
				{name: 'Цена', key: 'price', orig: '6'},
				{name: 'Проба', key: 'proba', orig: '7'},
		...
		window.Ev.parser_delta = {
			...
			setLabels: function () {
				...
				if (MEM.CSV.arrCsv.length > 0) {
					...
					TPL.GET_TPL('pages/admin/parser/delta/setLabels', {
						lenght: l,
