	...
	var init = function(){
        ...
        MEM.CSV = {
            ...
            labels : [
                ...
                { name:'Вид изделия', key:'title', orig:'1'},
                { name:'Вес', key:'weight', orig:'2'},
                { name:'Цена', key:'price', orig:'3'},
                { name:'Описание', key:'optionLabel', orig:'4'},
                { name:'Комплект', key:'Komplect', orig:'5'},
                { name:'Цвет металла', key:'cvetMett', orig:'6'},
                { name:'Размер', key:'size', orig:'7'},
                { name:'Проба', key:'proba', orig:'8'},
                { name:'Коллекция', key:'collection', orig:'9'},
                { name:'Для кого', key:'dlaKogo', orig:'14'},
                { name:'Событие', key:'events', orig:'15'},
                { name:'Фото', key:'photo', orig:'17'}
            ],
            extract : []
        };
