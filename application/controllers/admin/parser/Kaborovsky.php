...
//		}
		if (count($products) > 0) {
			$propertyNamesForStones = [
				...
				'Бриллиант' => ['Кол-во камней', 'Камень', 'Форма огранки', 'Кол-во граней', 'Рассев', 'Вес, Ct.', 'Цвет/Чистота', 'Цвет'],
				'Бриллиант черн' => ['Кол-во камней', 'Камень', 'Форма огранки', 'Кол-во граней', 'Рассев', 'Вес, Ct.', 'Цвет/Чистота', 'Цвет'],
				'Бриллиант ф-я' => ['Кол-во камней', 'Камень', 'Форма огранки', 'Кол-во граней', 'Рассев', 'Вес, Ct.', 'Цвет/Чистота', 'Цвет'],
				'Сапфир' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-', '-', '-'],
				'Сапф.' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-', '-', '-'],
				'Рубин' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-', '-', '-'],
				'Изумруд' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-', '-', '-'],
				'Топаз' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-', '-', '-'],
				'Аметист' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-'],
				'Гранат' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-'],
				'Агат' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-'],
				'Цитрин' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-'],
				'Кварц' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-', '-'],
				'Жемчуг' => ['Кол-во камней', 'Вес, Ct.', 'Камень', '-', '-', '-'],
			];
			// Названия камней
...
//				$stoneNameIndexes[] = array_search('Камень', $stonePropertyNames);
			...
			foreach ($products as $product) {
				...
				$stoneDatasList = explode('^', $optionLabel['characteristic']);
...
//								}
	...
	public function path_1()
	{
		...
		$this->db->like('title', 'Брошь');
		$r = $this->db->get('products')->result_array();

		echo count($r);

		foreach ($r as $key => $value) {
			$title = str_replace("Брошь", "Брошь ", $value['title']);
